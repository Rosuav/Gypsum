...
class zadvoptions
{
	...
	mapping(string:mapping(string:mixed)) items=([
		...
		"Internet protocols":(["path":"connection/protocol","default":"","desc":"Gypsum can use IPv4 and/or IPv6 to establish connections, but you may choose to disable one or other.","options":(["":"Both (first to respond is used)","4":"IPv4 only","6":"IPv6 only"])]),
