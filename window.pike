...
void makewindow()
{
	...
	mainwindow->add_accel_group(accel)->add(GTK2.Vbox(0,0)
		...
		->pack_end(win->statusbar=GTK2.Hbox(0,0)->set_size_request(0,-1),0,0,0) //TODO: Make the size request optional. Some might want a shrinking statusbar, some might want to ensure they see everything.
		#if constant(COMPAT_SIGNAL)
...
void create(string name)
{
	...
	*/
	...
	{
		program me=this_program; //Note that this_program[const] doesn't work in Pike 7.8.866 due to a bug fixed in afa24a (8.0 branch only).
