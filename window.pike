...
class connect_menu
{
	...
	//TODO: Have a drop-down list of connection types - Plain, Telnet, and maybe later SSL or IRC(???); default to "Autodetect" which picks between Plain and Telnet (current behaviour)
