...
int main(int argc,array(string) argv)
{
	...
	mapping(string:int) compat=([
		...
		"pausekey":0, //"Pause" key generates VoidSymbol 0xFFFFFF instead of Pause 0xFF13
		"boom2":1, //Lacks the 'boom2' bugfix - see usage
	]);
	#ifdef __NT__
	compat->pausekey=1; //Windows seems to have this issue, and Linux not. Beyond that I don't know.
	#endif
