...
%% to run Pike or Gypsum, however.");
	say(0,"%% Target directory: "+target); //TODO: Allow the user to open this directory and ./newgtk as folders (if it'd help; maybe it wouldn't, due to need for admin rights)
