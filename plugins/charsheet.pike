	...
	*/
	GTK2.Widget calc(string formula,string|void name,string|void type)
	{
		...
		catch
		{
			...
			symbols=(<>);
			program p=compile("mixed _="+formula+";",this); //Note: Under versions of Pike up to and including 8.1, p must be retained or the compile() call will be optimized out!
