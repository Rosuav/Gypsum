		...
		switch (iac[0])
		{
			...
			case DO: case DONT: case WILL: case WONT:
			{
				switch (iac[1])
				{
					...
					default: break; //Should we explicitly reject (respond negatively to) unrecognized DO/WILL requests? Currently Gypsum doesn't seem to play nicely with some non-MUD servers.
				}
				iac=iac[2..];
				break;
			}
