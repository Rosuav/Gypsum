...
void create(string name)
{
	...
	add_gypsum_constant("send",send); //Note that due to a Pike oddity (bug??), having this reference higher in the file than the function definition will cause an undesirable self-retrieval from globals.
}
